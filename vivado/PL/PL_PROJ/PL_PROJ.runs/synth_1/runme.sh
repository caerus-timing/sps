...
HD_PWD='/home/adam/repos/sig-gen-name-tbd/vivado/PL_PROJ_MASTER/PL_PROJ/PL_PROJ.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pl_sys_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pl_sys_top.tcl
